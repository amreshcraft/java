...
Student(String title , String author , float price,Sport sport){
    ...
    public String toString() {
        System.out.println("Title : " + title+", Author: "+ author+", Price: "+price+", Sport : "+this.sport.name+", Participated: "+this.sport.isParticipated);
...
public class ShallowCloneableApp {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        student2.author = "Shree Paad Damodar Satveleakar Sahab";
